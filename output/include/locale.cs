...
namespace runnerDotNet
{
	public partial class CommonFunctions
	{
		public static void InitLocale()
		{
			...
			GlobalVars.locale_info["LOCALE_CTRYNAME"] = "ZA";
			// date settings
			GlobalVars.locale_info["LOCALE_ICENTURY"] = "1";
			GlobalVars.locale_info["LOCALE_IDATE"] = "2";
			GlobalVars.locale_info["LOCALE_ILDATE"] = "1";
			GlobalVars.locale_info["LOCALE_SDATE"] = "/";
			GlobalVars.locale_info["LOCALE_SLONGDATE"] = "dddd, dd MMMM yyyy";
			GlobalVars.locale_info["LOCALE_SSHORTDATE"] = "yyyy/MM/dd";
			// weekday names
