...
namespace runnerDotNet
{
    public class tDAL : XClass
    {
        ...
        {
			var connection = GlobalVars.cman.byId( "PermisosDB_at_192_168_1_123" );
			return connection.addTableWrappers("dbo.EMPLEADO");
        }
		...
		public XVar acceso_uggroups
		{
			get
			{
				return Table("acceso_uggroups");
			}
		}
		public XVar acceso_ugmembers
		{
			get
			{
				return Table("acceso_ugmembers");
			}
		}
		public XVar acceso_ugrights
		{
			get
			{
				return Table("acceso_ugrights");
			}
		}
		public XVar DEPARTAMENTO
		{
			get
			{
				return Table("DEPARTAMENTO");
			}
		}
		public XVar EMPLEADO
		{
			get
			{
				return Table("EMPLEADO");
			}
		}
		public XVar ESTADO_COMPESADO
		{
			get
			{
				return Table("ESTADO_COMPESADO");
			}
		}
		public XVar ESTADO_PERSONALES
		{
			get
			{
				return Table("ESTADO_PERSONALES");
			}
		}
		public XVar GRUPOS
		{
		...
		public XVar Permisos2
		{
			get
			{
				return Table("Permisos2");
			}
		}
		public XVar PERMISOSGRUPOS
		{
			get
			{
				return Table("PERMISOSGRUPOS");
			}
		}
		public XVar Preferencias
		{
			get
			{
				return Table("Preferencias");
			}
		}
		public XVar REGISTRO_HORAS_COMPESADAS
		{
			get
			{
				return Table("REGISTRO_HORAS_COMPESADAS");
			}
		}
		public XVar TIPOEMPLEADO
		{
			get
			{
				return Table("TIPOEMPLEADO");
			}
		}
		public XVar TIPOPERMISO
		{
			get
			{
				return Table("TIPOPERMISO");
			}
		}
        ...
        public void FillTablesList()
        {
			...
			this.lstTables.Add(new XVar("name", "acceso_uggroups", "varname", "PermisosDB_at_192_168_1_123_dbo_acceso_uggroups", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "acceso_ugmembers", "varname", "PermisosDB_at_192_168_1_123_dbo_acceso_ugmembers", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "acceso_ugrights", "varname", "PermisosDB_at_192_168_1_123_dbo_acceso_ugrights", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "DEPARTAMENTO", "varname", "PermisosDB_at_192_168_1_123_dbo_DEPARTAMENTO", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "EMPLEADO", "varname", "PermisosDB_at_192_168_1_123_dbo_EMPLEADO", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "ESTADO_COMPESADO", "varname", "PermisosDB_at_192_168_1_123_dbo_ESTADO_COMPESADO", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "ESTADO_PERSONALES", "varname", "PermisosDB_at_192_168_1_123_dbo_ESTADO_PERSONALES", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "GRUPOS", "varname", "PermisosDB_at_192_168_1_123_dbo_GRUPOS", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "HORARIOS", "varname", "PermisosDB_at_192_168_1_123_dbo_HORARIOS", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "Permisos2", "varname", "PermisosDB_at_192_168_1_123_dbo_Permisos2", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "PERMISOSGRUPOS", "varname", "PermisosDB_at_192_168_1_123_dbo_PERMISOSGRUPOS", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "Preferencias", "varname", "PermisosDB_at_192_168_1_123_dbo_Preferencias", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "REGISTRO_HORAS_COMPESADAS", "varname", "PermisosDB_at_192_168_1_123_dbo_REGISTRO_HORAS_COMPESADAS", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "TIPOEMPLEADO", "varname", "PermisosDB_at_192_168_1_123_dbo_TIPOEMPLEADO", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
			this.lstTables.Add(new XVar("name", "TIPOPERMISO", "varname", "PermisosDB_at_192_168_1_123_dbo_TIPOPERMISO", "connId", "PermisosDB_at_192_168_1_123", "schema", "dbo", "connName", "PermisosDB at DESKTOP-63PFRJH"));
        }
